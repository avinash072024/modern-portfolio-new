export class Constants {
    ...
    public static THEME_KEY: string = (this.APP_NAME_COMBINE + '-' + 'portfolio-theme').toLowerCase();
    public static SKIN_KEY: string = (this.APP_NAME_COMBINE + '-' + 'portfolio-skin').toLowerCase();
}
